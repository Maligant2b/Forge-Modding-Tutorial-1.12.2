## Minecraft Forge 1.12 - Modding Tutorial
The complete source code for my Forge 1.12 modding tutorial series. If you haven't watched my series, [click here](https://www.youtube.com/watch?v=rmWBP5ifDlw&list=PLDhiRTZ_vnoX4bx_BJccGV7MjpXUfVJSn). Throughout it, you will learn to code your own Minecraft Mod from scratch, starting with basic concepts and working through the entire API! Version 1.12 is no longer support by Forge or the modding community! Please update to the latest version.
